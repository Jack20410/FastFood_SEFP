                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" CssClass="badge badge-danger" runat="server"
                                                                        CommandArgument='<%# Eval("CategoryId") %>' CommandName="delete"
                                                                        OnClientClick="return conirm('Do you want to delete this category?);">
